...
$(document).ready(function() {
    ...
    $('body').on('submit', '#borrowRequest', function (e) {
        ...
        console.log(web3.toWei(creditRequestedAmount, "ether"));
        console.log(creditRequestedInstallmentsCount);
        console.log(peerToPeerLendingContractInstance);

        peerToPeerLendingContractInstance.applyForCredit(web3.toWei(creditRequestedAmount, "ether").toString(10),creditRequestedInstallmentsCount,creditDescription, function(err, result) {
            if (err){
                console.log(err);
